...
class PaymentDetailsView(CorePaymentDetailsView):
    ...
    def handle_payment(self, order_number, total, **kwargs):
        """
        Instead of processing the payment directly, we redirect to Paystack
        """
        ...
        callback_url = self.request.build_absolute_uri('/paystack/callback/')
        email = self.request.user.email
        amount = int(total.incl_tax * 100)  # Paystack expects amount in kobo
        ...
        """
        This method is triggered during place_order. 
        You save the payment info here.
        """
        # Create or get source type (Paystack)
        ...
        source = Source(
         ...
         # Register it with the checkout session
        ...
        if result['status']:
            ...
            # Handle failure
            raise Exception("Paystack initialization failed: " + result['message'])
